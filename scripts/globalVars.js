...
// client.js
// Assuming you have a function to get the move history
function getMoveHistory() {
  // Logic to get the move history
  // For example, you might have a global variable like moveHistory
  return moveHistory;
}

// Function to send move data to the server
function sendMoveDataToServer(moveHistory) {
  // AJAX request to send move history to the server
...
// Example usage: Call this function whenever you want to send move data to the server
function sendMoveData() {
  const moveHistory = getMoveHistory();
  sendMoveDataToServer(moveHistory);
}
